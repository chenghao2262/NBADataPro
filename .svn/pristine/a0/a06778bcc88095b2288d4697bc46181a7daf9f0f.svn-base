...
public class TeamMiddlePanel extends JPanel{
	...
	String name;
	String nameOPP = "0";//为了球队演化做两球队对比时区分
	public static int type;
	
	public String digramItemSelected = "五人组合";//默认
...
//			setTeamVSPanel(team,avg); 
	...
	public void updateEvolutionOPP(String name){
		this.nameOPP = name;
		updateDiagram("演化历程");
	}
	...
	public void setVSTopPanel(TeamMiddlePanel middle){
		...
		System.out.println("DDRTHVHJHBH");
	...
	public void setHotZonePanel(){
		hotZonePanel = new HotRegionPane(vo.id, false, season);
