...
public class PlayerData_stub implements PlayerDataService{
	...
	public ShotAnlsPO shootAnalysis(int playerID, int season) {
		ShotAnlsPO po = new ShotAnlsPO();
		po.Att = new double[]{0,0,1,0};
		po.eFG = new double[]{0,0,1,0};
		po.Ast = new double[]{0,0,1,0};
		po.Pts = new double[]{0,0,0,0};
		po.Blk = new double[]{0,0,0.1,0};
		return po;
	}
	...
	public ShotAnlsPO shotClockAnls_clutch(int playerID, int season) {
		ShotAnlsPO po = new ShotAnlsPO();
		po.Att = new double[]{0.39,0.23,0.25,13};
		po.eFG = new double[]{0.543,0.420,0.488,0.262};
		po.Ast = new double[]{0.55,0.81,0.88,0.88};
		po.Pts = new double[]{3.7,1.7,2.1,0.6};
		po.Blk = new double[]{0.18,0.1,0.1,0.10};
		return po;
	}
